...
typedef int32_t mds_namespace_t;



BOOST_STRONG_TYPEDEF(uint64_t, mds_gid_t)
extern const mds_gid_t MDS_GID_NONE;
extern const mds_namespace_t MDS_NAMESPACE_NONE;
// The namespace ID of the anonymous default filesystem from legacy systems
extern const mds_namespace_t MDS_NAMESPACE_ANONYMOUS;
...
class mds_role_t
{
  ...
  mds_rank_t rank;
  mds_namespace_t ns;
  mds_role_t(mds_namespace_t ns_, mds_rank_t rank_)
    : rank(rank_), ns(ns_)
  {}
  mds_role_t()
    : rank(MDS_RANK_NONE), ns(MDS_NAMESPACE_NONE)
  {}
