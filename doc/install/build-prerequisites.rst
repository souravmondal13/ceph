...
installed on your host. ::
	...
	sudo apt-get install autotools-dev autoconf automake cdbs gcc g++ git libboost-dev libboost-program-options-dev libboost-thread-dev libedit-dev libssl-dev libtool libfcgi libfcgi-dev libfuse-dev linux-kernel-headers libcrypto++-dev libcrypto++ libexpat1-dev pkg-config
